...
namespace Influxdb2.Client
{
    ...
    public static partial class Flux
    {
        ...
        {
            return flux.Pipe($"|> range(start:{start})", false);
        }
        ...
        {
            return flux.Pipe($"|> range(start:{start:O})", false);
        }
        ...
        {
            return flux.Pipe($"|> range(start:{start}, stop:{stop})", false);
        }
        ...
        {
            return flux.Pipe($"|> range(start:{start}, stop:{stop:O})", false);
        }
        ...
        {
            return flux.Pipe($"|> range(start:{start:O}, stop:{stop})", false);
        }
        ...
        {
            return flux.Pipe($"|> range(start:{start:O}, stop:{stop:O})", false);
        }
